...
Distribution evidence: public prerelease [0.1.0-alpha.1](https://github.com/Henrixbor/ai-disclosure/releases/tag/v0.1.0-alpha.1), source commit 399bb2081787d8bd8bc3843e0b556e031bb2b674. Skill/plugin archives and checksums were downloaded and matched locally. The Codex schema validator and Claude strict validator passed. Claude catalog metadata pins the public archive; Codex project installation remains the supported route. No official catalog listing or independent legal review is claimed.

Claude catalog installation was exercised using a temporary CLAUDE_CONFIG_DIR: the public archive downloaded, installed, exposed exactly one skill and zero agents/hooks/servers, and its publishing CLI executed. Claude estimates roughly 69 always-on tokens and 460 invocation tokens for the skill (host estimates, not guarantees).
