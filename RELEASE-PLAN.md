...
| --- | --- | --- |
| Maintained policy, uncertainty and evidence | Dated official sources in skill references; versioned assessment decisions; unknown facts remain unresolved; review tied to revision | Independent legal review and a maintained update/review process |
...
| Tests and safe operation | Python 3.9/3.13 Linux/macOS CI; browser job; local suite now 51 tests | Final verification against deployed customer integrations and remaining modalities |
