...
Supported tools include static article/image notices, local chat interaction wrappers and experimental media controls. External widgets, general runtime frameworks, exports and provider marking remain integration gaps. Independent legal review has not been obtained.
